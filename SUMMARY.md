...
- [Calico](calico/README.md)
  ...
  - Getting Started
    - Bare Metal
      - Installation
        ...
        * [Install On Non Cluster Hosts](calico/getting-started/bare-metal/installation/index.md)
    ...
    - Openstack
      - Installation
        ...
        * [Install Calico On Open Stack](calico/getting-started/openstack/installation/index.md)
      ...
      * [Open Stack](calico/getting-started/openstack/index.md)
  ...
  - Reference
    ...
    - [Calicoctl](calico/reference/calicoctl/index.md)
      - [Datastore](calico/reference/calicoctl/datastore/index.md)
        - Migrate
          ...
          * [Migrate](calico/reference/calicoctl/datastore/migrate/index.md)
    ...
    - Etcd Rbac
      ...
      * [Configuring Etcd RBAC](calico/reference/etcd-rbac/index.md)
